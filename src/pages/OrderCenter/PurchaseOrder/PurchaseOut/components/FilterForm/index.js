        ...
        return (
            <div className="qtoolOms-condition">
                <Form className="serach-common-form" ref={this.formRef}{...this.formItemLayout}>
                    <Row gutter={24}>
                        <Col {...this.colspans}>
                            <FormItem label="采退单号" name="stockingReCode" {...this.formItemLayout}>
                                <Input placeholder="请输入采退单号" autoComplete="off"/>
                            </FormItem>
                        </Col>
                        <Col {...this.colspans}>
                        ...
                        <Col {...this.colspans}>
                            <FormItem name="stockingCode" label="关联采购单号" {...this.formItemLayout}>
                                <Input placeholder="请输入关联采购单号" autoComplete="off"/>
                            </FormItem>
                        </Col>
                      <Col {...this.colspans}>
