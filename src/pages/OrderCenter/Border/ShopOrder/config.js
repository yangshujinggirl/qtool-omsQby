 ...
 * @type {number}
 */
export const AUDIT_STATUS_STAY_IN_A_SINGLE = 11;
/**
 * 订单状态待发货
 * @type {number}
 */
 ...
 * @type {number}
 */
export const AUDIT_STATUS_SENT = 20;
/**
 * 订单状态已取消
 * @type {number}
 */
export const AUDIT_STATUS_CANCEL = 30;
 ...
 * @type {number}
 */
export const ORDER_FROM_Q_TOY_STORY_LAND = 2;
/**
 * 订单来源-掌柜
 * @type {number}
 */
export const ORDER_FROM_Q_SHOPKEEPER = 1;
 ...
 * @type {number}
 */
export const PRE_SELL_STATUS_NO = 0;
