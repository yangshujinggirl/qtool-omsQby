  ...
  return (
    <div>
      <Card title="订单信息" className="base_info">
        ...
        <Form.Item label="流程状态">{orderInfo.flowStatusStr}</Form.Item>
        ...
        <Form.Item label="用户支付配送费">
          {orderInfo.standardExpressAmount}
        </Form.Item>
      ...
      <Card title="门店信息" className="base_info">
        ...
        <Form.Item label="店主姓名">{spShopInfo.channelOrderNo}</Form.Item>
        <Form.Item label="店主电话">{spShopInfo.deliveryTypeStr}</Form.Item>
        <Form.Item label="门店电话">{spShopInfo.phone}</Form.Item>
      </Card>
