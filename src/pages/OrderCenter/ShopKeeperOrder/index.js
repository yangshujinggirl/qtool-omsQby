...
class ShopKeeperOrder extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible:false, 
  ...
  componentDidMount = () => {
    this.props.dispatch({
      type: "shopKeeperOrder/fetchList",
      payload: {
...
function mapStateToProps(state) {
  const { ShopKeeperReducers } = state;
  return ShopKeeperReducers;
}
export default connect(mapStateToProps)(ShopKeeperOrder);
