...
import {
    ...
    SALE_IN_OUT_ORDER_STATE_OFF_THE_STOCKS, SALE_IN_OUT_ORDER_STATE_REFUNDED,
    ...
    SHOPKEEPER_COST_TYPE_ORDER,
    SHOPKEEPER_COST_TYPE_SALES_OF_THE_REFUND,
    SHOPKEEPER_COST_TYPE_SALES_REVENUE,
    SHOPKEEPER_COST_TYPE_SETTLEMENT_OF_CASHIER,
    SHOPKEEPER_COST_TYPE_STORE_TOP_UP,
    SHOPKEEPER_COST_TYPE_WITHDRAWAL_RELEASE,
                        ...
                        <Col {...this.colspans}>
                            <FormItem name="deliveryType" label="配送方式" {...this.formItemLayout}>
                                <Select placeholder="请选择配送方式" allowClear={true}>
                                    <Option
                                        value={SALE_IN_OUT_DELIVERY_TYPE_STORES_TO_THE}>门店自提</Option>
                                    <Option
                                        value={SALE_IN_OUT_DELIVERY_TYPE_INTRA_CITY_SERVICE}>同城配送</Option>
                                    <Option
                                        value={SALE_IN_OUT_DELIVERY_TYPE_EXPRESS_MAIL}>快递邮寄</Option>
                                </Select>
                            </FormItem>
                        </Col>
                        <Col {...this.colspans}>
                            <FormItem label="订单状态" name="incomeStatus"   {...this.formItemLayout}>
                                <Select placeholder="请选择订单状态" allowClear={true}>
                                    <Option
                                        value={SALE_IN_OUT_ORDER_STATE_OFF_THE_STOCKS}>已完成</Option>
                        ...
                        <Col {...this.colspans}>
                            <FormItem label="费用类型" name="costType"   {...this.formItemLayout}>
                                <Select placeholder="请选择费用类型" allowClear={true}>
                                    <Option
                                        value={SALE_IN_OUT_COST_TYPE_SALES_RECEIPTS}>销售收款</Option>
                                    <Option
                                        value={SALE_IN_OUT_COST_TYPE_SALES_OF_THE_REFUND}>销售退款</Option>
                                </Select>
                            </FormItem>
                        </Col>
                        <Col {...this.colspans}>
                            <FilterSearchRangeTime
                                ...
                                startTimeName="dateTimeST" endTimeName="dateTimeET" label="时间选择"
