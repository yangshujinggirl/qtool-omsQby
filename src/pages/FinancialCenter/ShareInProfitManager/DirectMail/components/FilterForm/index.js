...
import {
    SHARE_IN_PROFIT_DIRECT_MAIL_COST_TYPE_SALES_OF_THE_REFUND,
    SHARE_IN_PROFIT_DIRECT_MAIL_COST_TYPE_SALES_RECEIPTS
} from "../../config";
                    ...
                    <Row gutter={24}>
                        ...
                        <Col {...this.colspans}>
                            <FormItem label="费用类型" name="shareType"   {...this.formItemLayout}>
                                <Select placeholder="请选择费用类型" allowClear={true}>
                                    <Option
                                        value={SHARE_IN_PROFIT_DIRECT_MAIL_COST_TYPE_SALES_RECEIPTS}>分润收款</Option>
                                    <Option
                        ...
                        <Col {...this.colspans}>
                            <FilterSearchRangeTime
                                ...
                                startTimeName="createST" endTimeName="createET" label="时间选择"
