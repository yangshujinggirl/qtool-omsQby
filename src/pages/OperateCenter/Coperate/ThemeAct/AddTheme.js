...
const Bpush = (props) => {
	...
	const handleSubmit = async () => {
		...
		_values.indexPicUrl = indexPicUrl[0].response ? indexPicUrl[0].response.result : indexPicUrl[0].img;
		_values.listPagePicUrl = listPagePicUrl[0].response ? listPagePicUrl[0].response.result : listPagePicUrl[0].img;
		if (id) {
	...
	return (
		<div className="oms-common-addEdit-pages add_theme">
			<Form form={form} {...formItemLayout} className="common-addEdit-form">
				...
				<Form.Item label="活动图片" className="item_required">
					<Form.Item>
