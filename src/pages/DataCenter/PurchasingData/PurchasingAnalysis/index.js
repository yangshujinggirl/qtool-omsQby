...
import {
    GetPurchasingAnalysisData,
    GetPurchasingAnalysisDataList
} from "api/home/DataCenter/BaseData/PurchasingData";
...
const PurchasingAnalysis = (props) => {
    ...
    const baseDetailComponentCallback = (_this) => {
        _this.showLoading();
        const iRpPurchaseAnalysis = new GetPurchasingAnalysisData().iRpPurchaseAnalysis;
        iRpPurchaseAnalysis.purchaseAmountRate = CommonUtils.dataDifferenceValueComparison(iRpPurchaseAnalysis.purchaseAmount, iRpPurchaseAnalysis.upPurchaseAmount); //采购金额
        iRpPurchaseAnalysis.purchaseQtyRate = CommonUtils.dataDifferenceValueComparison(iRpPurchaseAnalysis.purchaseQty, iRpPurchaseAnalysis.upPurchaseQty); //采购数量
        iRpPurchaseAnalysis.returnAmountRate = CommonUtils.dataDifferenceValueComparison(iRpPurchaseAnalysis.returnAmount, iRpPurchaseAnalysis.upReturnAmount); //才退金额
        iRpPurchaseAnalysis.returnQtyRate = CommonUtils.dataDifferenceValueComparison(iRpPurchaseAnalysis.returnQty, iRpPurchaseAnalysis.upReturnQty); //才退数量
        const datalist = [{
            title: '本月采购金额',
        ...
        let tableList = new GetPurchasingAnalysisDataList().analysis;
        setTableList(TableDataListUtil.addKeyAndResultList(tableList));
        _this.hideLoading()
    };
