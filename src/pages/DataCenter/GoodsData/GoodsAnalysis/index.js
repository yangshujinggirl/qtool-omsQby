	...
	render() {
		return (
			<Spin spinning={this.state.loading}>
				<TopTitleDesHeader updateTime={this.state.updateTime} desInfoClick={this.desInfo.bind(this)} />
				...
				>
					<GoodsDataAnalysisCharts showLoading={this.showLoading} hideLoading={this.hideLoading} />
				</div>
			</Spin>
		);
	}
