                        ...
                        <Col {...this.colspans}>
                            <FormItem name="expireType" label="到期天数" {...this.formItemLayout}>
                                <Select allowClear={true} placeholder='请选择一级分类'>
                                    <Option
                                        value={COMMODITY_EXPIRY_SATE_TYPE_OUT_OF_DATE}>已过期</Option>
                                    <Option
                                        value={COMMODITY_EXPIRY_SATE_TYPE_EXPIRED_IN_SEVEN_DAYS}>7天内过期</Option>
                                    <Option
                                        value={COMMODITY_EXPIRY_SATE_TYPE_EXPIRED_IN_THIRTY_DAYS}>30天内过期</Option>
                                    <Option
                                        value={COMMODITY_EXPIRY_SATE_TYPE_EXPIRED_IN_NINETY_DAYS}>90天内过期</Option>
                                </Select>
                            </FormItem>
                        </Col>
                    </Row>
