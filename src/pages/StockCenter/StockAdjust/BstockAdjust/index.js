...
import {
  getStockListApi,
  getChangedStockApi
} from "api/home/StockCenter/StockAdjust/BstockAdjust";
import "./index.less";
const formLayout = {
  labelCol: { span: 8 },
  wrapperCol: { span: 16 }
...
const StockAdjust = () => {
  ...
  const searchStock = e => {
    ...
    setShowLoading(true)
    getStockListApi(value).then(res => {
      if (res.httpCode == 200) {
        const {
          skuCode,
          productName,
  ...
  return <QbaseDetail showLoading={showLoading} childComponent={ <div className="stock_adjust">
