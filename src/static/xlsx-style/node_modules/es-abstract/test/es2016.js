...
var ES = require('es-abstract').ES2016;

var ops = require('es-abstract/operations/2016');
...
require('es-abstract/test/tests').es2016(ES, ops, expectedMissing);

require('es-abstract/test/helpers/runManifestTest')(require('tape'), ES, 2016);
