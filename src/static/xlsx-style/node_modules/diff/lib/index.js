...
/*istanbul ignore end*/var /*istanbul ignore start*/_base = require('diff/lib/diff/base') /*istanbul ignore end*/;

/*istanbul ignore start*/var _base2 = _interopRequireDefault(_base);

/*istanbul ignore end*/var /*istanbul ignore start*/_character = require('diff/lib/diff/character') /*istanbul ignore end*/;

var /*istanbul ignore start*/_word = require('diff/lib/diff/word') /*istanbul ignore end*/;

var /*istanbul ignore start*/_line = require('diff/lib/diff/line') /*istanbul ignore end*/;

var /*istanbul ignore start*/_sentence = require('diff/lib/diff/sentence') /*istanbul ignore end*/;

var /*istanbul ignore start*/_css = require('diff/lib/diff/css') /*istanbul ignore end*/;

var /*istanbul ignore start*/_json = require('diff/lib/diff/json') /*istanbul ignore end*/;

var /*istanbul ignore start*/_array = require('diff/lib/diff/array') /*istanbul ignore end*/;

var /*istanbul ignore start*/_apply = require('diff/lib/patch/apply') /*istanbul ignore end*/;

var /*istanbul ignore start*/_parse = require('diff/lib/patch/parse') /*istanbul ignore end*/;

var /*istanbul ignore start*/_merge = require('diff/lib/patch/merge') /*istanbul ignore end*/;

var /*istanbul ignore start*/_create = require('diff/lib/patch/create') /*istanbul ignore end*/;

var /*istanbul ignore start*/_dmp = require('diff/lib/convert/dmp') /*istanbul ignore end*/;

var /*istanbul ignore start*/_xml = require('diff/lib/convert/xml') /*istanbul ignore end*/;
