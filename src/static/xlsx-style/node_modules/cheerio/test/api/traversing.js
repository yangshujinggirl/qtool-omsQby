var expect = require('expect.js'),
  ...
  food = require('cheerio/test/fixtures').food,
  fruits = require('cheerio/test/fixtures').fruits,
  drinks = require('cheerio/test/fixtures').drinks,
  text = require('cheerio/test/fixtures').text;
