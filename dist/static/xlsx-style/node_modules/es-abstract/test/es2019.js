...
var ops = require('es-abstract/operations/2019');
...
require('es-abstract/test/tests').es2019(ES, ops, expectedMissing);

require('es-abstract/test/helpers/runManifestTest')(require('tape'), ES, 2019);
