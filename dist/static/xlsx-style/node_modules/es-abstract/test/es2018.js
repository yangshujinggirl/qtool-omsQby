...
var ops = require('es-abstract/operations/2018');
...
require('es-abstract/test/tests').es2018(ES, ops, expectedMissing);

require('es-abstract/test/helpers/runManifestTest')(require('tape'), ES, 2018);
