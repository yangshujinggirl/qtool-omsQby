...
var ops = require('es-abstract/operations/2017');
...
require('es-abstract/test/tests').es2017(ES, ops, expectedMissing);

require('es-abstract/test/helpers/runManifestTest')(require('tape'), ES, 2017);
